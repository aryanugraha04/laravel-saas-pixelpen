                        ...
                        <div class="row g-3 gx-gs">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <select name="category" class="form-select" id="category" aria-label="Default select example">
                                            ...
                                            <option value="Social" {{ $template->category == 'Social' ? 'selected' : '' }}>Social Media</option>
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="row input-field-row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="text" name="input_fields[0][title]" id="input_fields_0_title" class="form-control" 
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="text" name="input_fields[0][description]" id="input_fields_0_description" class="form-control" 
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="input_fields_0_description" class="form-label">Field Type * </label>
                                                <div class="form-control-wrap">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="hidden" name="input_fields[0][is_required]" id="input_fields_0_description" value="1">
                                                </div>
                                            </div>
                                        </div>
                                        @endforeach
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <small>Example: Write a 400 world article about {topic} with an introductions</small>
                                </div>
                            </div>
