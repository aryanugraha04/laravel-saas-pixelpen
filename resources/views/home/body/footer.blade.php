    ...
    <div class="section">
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-xl-2 col-sm-4 col-6">
                    <div class="wgs">
                        <h6 class="wgs-title overline-title text-heading mb-3">Pixelpen</h6>
                        <ul class="list gy-2 list-link-base">
                ...
                <div class="col-xl-4 col-lg-7 col-md-9 me-auto order-xl-first">
                    <div class="block-text">
                        ...
                        <p class="text-heading mt-4">&copy; 2025 Pixelpen. Template Made By <a target="_blank" href="https://pixelpen.com">Pixelpen</a> </p>
                    </div>
                </div>
            </div>
        </div><!-- .container -->
