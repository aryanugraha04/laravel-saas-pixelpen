    ...
    <div class="invoice-box">
        ...
        <div class="details">
            ...
            <div>
                ...
                <p><strong>Company:</strong> Pixelpen</p>
                <p><strong>Address:</strong> Jakarta, Indonesia</p>
                <p><strong>Email:</strong> support@pixelpen.com</p>
            </div>
        </div>
        ...
        <div class="footer">
            ...
            <p><strong>Payment Date: </strong> {{ \Carbon\Carbon::parse
            ($billing->payment_date)->format('F d, Y h:1 A') }} </p>
